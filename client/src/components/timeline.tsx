...
export default function Timeline() {
    return (
        <div className="xl:w-[1280px] lg:w-[900px] md:w-[850px] sm:w-[600px] h-full bg-white dark:text-black drop-shadow-2xl rounded-[50px] mb-[40px] pb-[60px] flex flex-col items-center justify-self-center justify-center text-center font-manrope gap-5 mt-10">
            <label htmlFor="" className=' flex flex-row pt-10 text-[28px] md:text-[48px] font-semibold bg-gradient-to-r from-[#FF0062] to-[#D0BCFF] inline-block text-transparent bg-clip-text'><img className='w-14 h-full mr-3 mt-3' src="/content-writing.png" alt="" />Let’s Write Something to create <br /> Secondary Brain</label>
