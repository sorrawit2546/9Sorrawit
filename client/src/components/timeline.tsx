...
export default function Timeline() {
    return (
        <div className="max-w-full lg:w-[1500px] h-full bg-white drop-shadow-2xl rounded-[50px] mt-[40px] mb-[40px] pb-[40px] flex flex-col items-center justify-self-center justify-center text-center font-manrope gap-5 ">
            ...
            <div className='flex flex-row w-full justify-center gap-10'>
                <div className='  rounded-[50px] w-[600px] h-[230px]'></div>
                <div className='border-[5px] border-black h-[300px]'></div>
                <div className='mr- border-[5px] border-black  bg-gradient-to-r from-[#FFD7A0] to-[#FF9797] rounded-[50px] w-[600px] h-[230px] mt-10'></div>
            </div>
